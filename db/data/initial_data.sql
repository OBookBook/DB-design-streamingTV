...
-- NOTE: テスト用 現在の日付でテストデータを生成できます。
-- INSERT INTO broadcasts (channel_id, program_id, season_id, episode_id, start_time, end_time, view_count) VALUES
-- -- ('アニメチャンネル1')で鬼滅の刃 シーズン1 を放送
-- (1, 1, 1, 1, CONCAT(CURDATE(), ' 00:00:00'), CONCAT(CURDATE(), ' 00:30:00'), 60000),
-- (1, 1, 1, 2, CONCAT(CURDATE(), ' 00:30:00'), CONCAT(CURDATE(), ' 01:00:00'), 70000),
-- (1, 1, 1, 3, CONCAT(CURDATE(), ' 01:00:00'), CONCAT(CURDATE(), ' 01:30:00'), 80000),
-- (1, 1, 1, 4, CONCAT(CURDATE(), ' 01:30:00'), CONCAT(CURDATE(), ' 02:00:00'), 90000),
-- (1, 1, 1, 5, CONCAT(CURDATE(), ' 02:00:00'), CONCAT(CURDATE(), ' 02:30:00'), 75000),
-- (1, 1, 1, 6, CONCAT(CURDATE(), ' 02:30:00'), CONCAT(CURDATE(), ' 03:00:00'), 85000),
-- (1, 1, 1, 7, CONCAT(CURDATE(), ' 03:00:00'), CONCAT(CURDATE(), ' 03:30:00'), 95000),
-- (1, 1, 1, 8, CONCAT(CURDATE(), ' 03:30:00'), CONCAT(CURDATE(), ' 04:00:00'), 105000),
-- (1, 1, 1, 9, CONCAT(CURDATE(), ' 04:00:00'), CONCAT(CURDATE(), ' 04:30:00'), 90000),
-- (1, 1, 1, 10, CONCAT(CURDATE(), ' 04:30:00'), CONCAT(CURDATE(), ' 05:00:00'), 100000),
-- (1, 1, 1, 11, CONCAT(CURDATE(), ' 05:00:00'), CONCAT(CURDATE(), ' 05:30:00'), 110000),
-- (1, 1, 1, 12, CONCAT(CURDATE(), ' 05:30:00'), CONCAT(CURDATE(), ' 06:00:00'), 120000),
-- (1, 1, 1, 13, CONCAT(CURDATE(), ' 06:00:00'), CONCAT(CURDATE(), ' 06:30:00'), 105000),
-- (1, 1, 1, 14, CONCAT(CURDATE(), ' 06:30:00'), CONCAT(CURDATE(), ' 07:00:00'), 115000),
-- (1, 1, 1, 15, CONCAT(CURDATE(), ' 07:00:00'), CONCAT(CURDATE(), ' 07:30:00'), 125000),
-- (1, 1, 1, 16, CONCAT(CURDATE(), ' 07:30:00'), CONCAT(CURDATE(), ' 08:00:00'), 135000),
-- (1, 1, 1, 17, CONCAT(CURDATE(), ' 08:00:00'), CONCAT(CURDATE(), ' 08:30:00'), 110000),
-- (1, 1, 1, 18, CONCAT(CURDATE(), ' 08:30:00'), CONCAT(CURDATE(), ' 09:00:00'), 120000),
-- (1, 1, 1, 19, CONCAT(CURDATE(), ' 09:00:00'), CONCAT(CURDATE(), ' 09:30:00'), 130000),
-- (1, 1, 1, 20, CONCAT(CURDATE(), ' 09:30:00'), CONCAT(CURDATE(), ' 10:00:00'), 140000),
-- (1, 1, 1, 21, CONCAT(CURDATE(), ' 10:00:00'), CONCAT(CURDATE(), ' 10:30:00'), 125000),
-- (1, 1, 1, 22, CONCAT(CURDATE(), ' 10:30:00'), CONCAT(CURDATE(), ' 11:00:00'), 135000),
-- (1, 1, 1, 23, CONCAT(CURDATE(), ' 11:00:00'), CONCAT(CURDATE(), ' 11:30:00'), 145000),
-- (1, 1, 1, 24, CONCAT(CURDATE(), ' 11:30:00'), CONCAT(CURDATE(), ' 12:00:00'), 155000),
-- (1, 1, 1, 25, CONCAT(CURDATE(), ' 12:00:00'), CONCAT(CURDATE(), ' 12:30:00'), 140000),
-- (1, 1, 1, 26, CONCAT(CURDATE(), ' 12:30:00'), CONCAT(CURDATE(), ' 13:00:00'), 150000),
-- -- ('アニメチャンネル2')で鬼滅の刃 シーズン2 を放送
-- (2, 1, 2, 27, CONCAT(CURDATE(), ' 13:00:00'), CONCAT(CURDATE(), ' 13:30:00'), 130000),
-- (2, 1, 2, 28, CONCAT(CURDATE(), ' 13:30:00'), CONCAT(CURDATE(), ' 14:00:00'), 140000),
-- (2, 1, 2, 29, CONCAT(CURDATE(), ' 14:00:00'), CONCAT(CURDATE(), ' 14:30:00'), 125000),
-- (2, 1, 2, 30, CONCAT(CURDATE(), ' 14:30:00'), CONCAT(CURDATE(), ' 15:00:00'), 135000),
-- (2, 1, 2, 31, CONCAT(CURDATE(), ' 15:00:00'), CONCAT(CURDATE(), ' 15:30:00'), 145000),
-- (2, 1, 2, 32, CONCAT(CURDATE(), ' 15:30:00'), CONCAT(CURDATE(), ' 16:00:00'), 155000),
-- (2, 1, 2, 33, CONCAT(CURDATE(), ' 16:00:00'), CONCAT(CURDATE(), ' 16:30:00'), 140000),
-- (2, 1, 2, 34, CONCAT(CURDATE(), ' 16:30:00'), CONCAT(CURDATE(), ' 17:00:00'), 150000),
-- (2, 1, 2, 35, CONCAT(CURDATE(), ' 17:00:00'), CONCAT(CURDATE(), ' 17:30:00'), 160000),
-- (2, 1, 2, 36, CONCAT(CURDATE(), ' 17:30:00'), CONCAT(CURDATE(), ' 18:00:00'), 170000),
-- (2, 1, 2, 37, CONCAT(CURDATE(), ' 18:00:00'), CONCAT(CURDATE(), ' 18:30:00'), 155000),
-- (2, 1, 2, 38, CONCAT(CURDATE(), ' 18:30:00'), CONCAT(CURDATE(), ' 19:00:00'), 165000),
-- (2, 1, 2, 39, CONCAT(CURDATE(), ' 19:00:00'), CONCAT(CURDATE(), ' 19:30:00'), 175000),
-- -- ('ドラマチャンネル1')逃げるは恥だが役に立つ シーズン1 を放送
-- (3, 2, 3, 40, CONCAT(CURDATE(), ' 00:00:00'), CONCAT(CURDATE(), ' 00:45:00'), 60000),
-- (3, 2, 3, 41, CONCAT(CURDATE(), ' 00:45:00'), CONCAT(CURDATE(), ' 01:30:00'), 70000),
-- (3, 2, 3, 42, CONCAT(CURDATE(), ' 01:30:00'), CONCAT(CURDATE(), ' 02:15:00'), 80000),
-- (3, 2, 3, 43, CONCAT(CURDATE(), ' 02:15:00'), CONCAT(CURDATE(), ' 03:00:00'), 90000),
-- (3, 2, 3, 44, CONCAT(CURDATE(), ' 03:00:00'), CONCAT(CURDATE(), ' 03:45:00'), 75000),
-- (3, 2, 3, 45, CONCAT(CURDATE(), ' 03:45:00'), CONCAT(CURDATE(), ' 04:30:00'), 85000),
-- (3, 2, 3, 46, CONCAT(CURDATE(), ' 04:30:00'), CONCAT(CURDATE(), ' 05:15:00'), 95000),
-- (3, 2, 3, 47, CONCAT(CURDATE(), ' 05:15:00'), CONCAT(CURDATE(), ' 06:00:00'), 105000),
-- (3, 2, 3, 48, CONCAT(CURDATE(), ' 06:00:00'), CONCAT(CURDATE(), ' 06:45:00'), 90000),
-- (3, 2, 3, 49, CONCAT(CURDATE(), ' 06:45:00'), CONCAT(CURDATE(), ' 07:30:00'), 100000),
-- -- ('ドラマチャンネル2')逃げるは恥だが役に立つ シーズン1 を放送
-- (4, 2, 3, 40, CONCAT(CURDATE(), ' 00:00:00'), CONCAT(CURDATE(), ' 00:45:00'), 60000),
-- (4, 2, 3, 41, CONCAT(CURDATE(), ' 00:45:00'), CONCAT(CURDATE(), ' 01:30:00'), 70000),
-- (4, 2, 3, 42, CONCAT(CURDATE(), ' 01:30:00'), CONCAT(CURDATE(), ' 02:15:00'), 80000),
-- (4, 2, 3, 43, CONCAT(CURDATE(), ' 02:15:00'), CONCAT(CURDATE(), ' 03:00:00'), 90000),
-- (4, 2, 3, 44, CONCAT(CURDATE(), ' 03:00:00'), CONCAT(CURDATE(), ' 03:45:00'), 75000),
-- (4, 2, 3, 45, CONCAT(CURDATE(), ' 03:45:00'), CONCAT(CURDATE(), ' 04:30:00'), 85000),
-- (4, 2, 3, 46, CONCAT(CURDATE(), ' 04:30:00'), CONCAT(CURDATE(), ' 05:15:00'), 95000),
-- (4, 2, 3, 47, CONCAT(CURDATE(), ' 05:15:00'), CONCAT(CURDATE(), ' 06:00:00'), 105000),
-- (4, 2, 3, 48, CONCAT(CURDATE(), ' 06:00:00'), CONCAT(CURDATE(), ' 06:45:00'), 90000),
-- (4, 2, 3, 49, CONCAT(CURDATE(), ' 06:45:00'), CONCAT(CURDATE(), ' 07:30:00'), 100000);
