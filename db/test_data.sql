...
-- エピソードデータ
INSERT INTO episodes (season_id, number, title, description, duration, release_date, view_count) VALUES
...
INSERT INTO episodes (season_id, number, title, description, duration, release_date, view_count) VALUES
  (4, '1', '第1話 犯罪の始まり', '犯罪の始まりを描く', '00:40:00', '2023-08-01', 5000),
  (4, '2', '第2話 警察の捜査', '警察の捜査活動', '00:40:00', '2023-08-08', 5200),
  (4, '3', '第3話 犯罪の裏側', '犯罪の裏側に迫る', '00:40:00', '2023-08-15', 9000),
  (4, '4', '第4話 決着の行方', '物語の決着', '00:40:00', '2023-08-22', 5300),
  (4, '5', '第5話 新たな展開', '物語に訪れる新たな展開', '00:40:00', '2023-08-29', 4800),
  (4, '6', '第6話 事件の真相', '事件の真相に迫る', '00:40:00', '2023-09-05', 5000);

-- スペース・オデッセイのシーズン1のエピソードデータ
INSERT INTO episodes (season_id, number, title, description, duration, release_date, view_count) VALUES
  (5, '1', '第1話 宇宙への旅立ち', '宇宙への旅立ちを描く', '00:50:00', '2023-08-05', 6000),
  (5, '2', '第2話 新たな惑星', '新たな惑星の探索', '00:50:00', '2023-08-12', 6200),
  (5, '3', '第3話 宇宙人との遭遇', '宇宙人との遭遇', '00:50:00', '2023-08-19', 5900),
  (5, '4', '第4話 宇宙探査の謎', '宇宙探査の謎に迫る', '00:50:00', '2023-08-26', 63000),
  (5, '5', '第5話 宇宙船の異常', '宇宙船の異常に立ち向かう', '00:50:00', '2023-09-02', 8000),
  (5, '6', '第6話 未知の領域', '未知の領域への冒険', '00:50:00', '2023-09-09', 6100);

-- サッカー最前線のシーズン1のエピソードデータ
INSERT INTO episodes (season_id, number, title, description, duration, release_date, view_count) VALUES
  (6, '1', '第1話 トーナメント開幕', 'トーナメント開幕を告げる試合', '00:55:00', '2023-07-30', 7200),
  (6, '2', '第2話 決勝への道', '決勝へ進むための試合', '00:55:00', '2023-08-06', 720),
  (6, '3', '第3話 激闘の行方', '激しい戦いの行方', '00:55:00', '2023-08-13', 690),
  (6, '4', '第4話 決勝戦', '決勝戦の行方を描く', '00:55:00', '2023-08-20', 5000),
  (6, '5', '第5話 優勝への道', '優勝への道のり', '00:55:00', '2023-08-27', 3000),
  (6, '6', '第6話 決着と感動', '物語の決着と感動のシーン', '00:55:00', '2023-09-03', 710);

-- ペットの楽園のシーズン1のエピソードデータ
INSERT INTO episodes (season_id, number, title, description, duration, release_date, view_count) VALUES
  (7, '1', '第1話 かわいいペットたち', 'かわいいペットたちのエピソード', '00:30:00', '2023-08-02', 3500),
  (7, '2', '第2話 ペットと飼い主の絆', 'ペットと飼い主の絆を描く', '00:30:00', '2023-08-09', 7000),
  (7, '3', '第3話 飼い主の奮闘', '飼い主の奮闘記', '00:30:00', '2023-08-16', 3400),
  (7, '4', '第4話 ペットの秘密', 'ペットの秘密に迫る', '00:30:00', '2023-08-23', 8000),
  (7, '5', '第5話 愛と友情', '愛と友情の物語', '00:30:00', '2023-08-30', 3300),
  (7, '6', '第6話 癒しの時間', '癒しのひと時を描く', '00:30:00', '2023-09-06', 6000);

-- 今日のヘッドラインのシーズン1のエピソードデータ
INSERT INTO episodes (season_id, number, title, description, duration, release_date, view_count) VALUES
  (8, '1', '第1話 最新ニュース', '最新ニュースの報道', '01:00:00', '2023-08-01', 8000),
  (8, '2', '第2話 世界の動き', '世界各地の動きを追う', '01:00:00', '2023-08-08', 2000),
  (8, '3', '第3話 ニュース特集', '特集記事を放送', '01:00:00', '2023-08-15', 7900),
  (8, '4', '第4話 緊急報道', '緊急の報道内容', '01:00:00', '2023-08-22', 8300),
  (8, '5', '第5話 政治情勢', '政治情勢に関する報道', '01:00:00', '2023-08-29', 7800),
  (8, '6', '第6話 最終回特番', '番組の最終回特番', '01:00:00', '2023-09-05', 1000);

-- 音楽の旅路のシーズン1のエピソードデータ
INSERT INTO episodes (season_id, number, title, description, duration, release_date, view_count) VALUES
  (9, '1', '第1話 スターたちの軌跡', '音楽スターたちの軌跡を追う', '00:50:00', '2023-07-31', 5000),
  (9, '2', '第2話 音楽の誕生', '音楽の誕生と歴史を辿る', '00:50:00', '2023-08-07', 1000),
  (9, '3', '第3話 世界の音楽', '世界各地の音楽を紹介', '00:50:00', '2023-08-14', 8500),
  (9, '4', '第4話 音楽の感動', '音楽による感動の瞬間', '00:50:00', '2023-08-21', 7000),
  (9, '5', '第5話 スターたちのパフォーマンス', '音楽スターたちのパフォーマンス', '00:50:00', '2023-08-28', 5000),
  (9, '6', '第6話 音楽の未来', '音楽の未来を見つめて', '00:50:00', '2023-09-04', 4100);
...
SELECT
    ...
    TIMESTAMPADD(HOUR, FLOOR(RAND() * 24), DATE_ADD('2023-05-12', INTERVAL FLOOR(RAND() * 1000) DAY)) AS start_time,  -- ランダムな開始時間
    TIMESTAMPADD(HOUR, FLOOR(RAND() * 24), DATE_ADD('2023-05-12', INTERVAL FLOOR(RAND() * 1000) DAY)) AS end_time,    -- ランダムな終了時間
